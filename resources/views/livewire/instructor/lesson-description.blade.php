            ...
            <div x-show="open">
                ...
                @if ($lesson->description)
                    <form wire:submit.prevent="update">
                        <textarea wire:model.defer="description.name" class="form-input w-full"></textarea>
                ...
                @else
                    <div wire:submit.prevent="update">
                        <textarea wire:model.defer="name" class="form-input w-full" placeholder="Agregue una descripción para la lección ..."></textarea>
